...
Bard.SpellLines = {
    ...
    { Group = 'overhaste',    Spells = { 'Ancient: Call of Power', 'Eriki\'s Psalm of Power', 'Yelhun\'s Mystic Call', 'Rizlona\'s Call of Flame', 'Warsong of the Vah Shir', 'Battlecry of the Vah Shir' },                                                                                       Options = { Gem = function(
