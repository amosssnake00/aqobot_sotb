...
function Enchanter:init()
    self.classOrder = { 'assist', 'mez', 'assist', 'aggro', 'debuff', 'burn', 'cast', 'mash', 'recover', 'buff', 'rest',
        'managepet', 'rez' }
...
function Enchanter:initClassOptions()
    self:addOption('AURA1', 'Aura 1', 'twincast', self.AURAS, 'The first aura to keep up', 'combobox', nil, 'Aura1',
        'string')
    self:addOption('AURA2', 'Aura 2', 'combatinnate', self.AURAS, 'The second aura to keep up', 'combobox', nil, 'Aura2',
        'string')
    ...
    self:addOption('USEHASTE', 'Buff Haste', true, nil, 'Toggle use of haste buff line', 'checkbox', nil, 'UseHaste',
        'bool')
    self:addOption('MEZST', 'Use Mez', true, nil, 'Use single target mez on adds within camp radius', 'checkbox', nil,
        'MezST', 'bool')
    self:addOption('MEZAE', 'Use AE Mez', true, nil, 'Use AE Mez if 3 or more mobs are within camp radius', 'checkbox',
        nil, 'MezAE', 'bool')
    self:addOption('MEZAECOUNT', 'AE Mez Count', 3, nil, 'Threshold to use AE Mez ability', 'inputint', nil, 'MezAECount',
        'bool')
    ...
    self:addOption('USESLOW', 'Use Slow', false, nil, 'Toggle use of single target slow ability', 'checkbox', nil,
        'UseSlow', 'bool')
    self:addOption('USESLOWAOE', 'Use Slow AOE', true, nil, 'Toggle use of AOE slow ability', 'checkbox', nil,
        'UseSlowAOE', 'bool')
    -- self:addOption('USESPELLGUARD', 'Use Spell Guard', true, nil, 'Toggle use of Spell Guard', 'checkbox', nil, 'UseSpellGuard', 'bool')
    self:addOption('USEDEBUFF', 'Use Tash', false, nil, 'Toggle use of single target tash ability', 'checkbox', nil,
        'UseDebuff', 'bool')
    self:addOption('USEDEBUFFAOE', 'Use Tash AOE', true, nil, 'Toggle use of AOE tash ability', 'checkbox', nil,
        'UseDebuffAOE', 'bool')
    self:addOption('USECRIPPLE', 'Use Cripple', true, nil, 'Toggle use of single target cripple ability', 'checkbox', nil,
        'UseCripple', 'bool')
    self:addOption('USEDISPEL', 'Use Dispel', true, nil, 'Dispel mobs with Eradicate Magic AA', 'checkbox', nil,
        'UseDispel', 'bool')
    self:addOption('DEBUFFONPULL', 'Debuff on Pull', true, nil, 'Debuff mobs immediately', 'checkbox', nil,
        'DebuffOnPull', 'bool')
...
Enchanter.SpellLines = {
    ...
    { Group = 'keigroup', Spells = { 'Voice of Preordination', 'Voice of Perception', 'Voice of Sagacity', 'Voice of Perspicacity', 'Voice of Precognition', 'Voice of Foresight', 'Voice of Premeditation', 'Voice of Forethought', 'Unified Alacrity', 'Voice of Clairvoyance', 'Voice of Quellious', 'Tranquility','Koadic\'s Endless Intellect', 'Boon of the Clear Mind' }, Options = { alias = 'KEI', selfbuff = true, opt = 'USEKEI' } },
    {
        Group = 'kei',
...
function Enchanter:recover()
    ...
    if mq.TLO.Me.PctMana() < 70 and self.azure then
        ...
        if cursor and cursor:find(self.azure.Name) then
