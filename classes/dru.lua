...
function Druid:init()
    self.classOrder = { 'heal', 'cure', 'assist', 'aggro', 'debuff', 'burn', 'cast', 'mash', 'recover', 'rez', 'buff',
        'rest', 'managepet' }
...
function Druid:initClassOptions()
    ...
    self:addOption('USEDEBUFF', 'Use Ro Debuff', false, nil, 'Use Blessing of Ro AA', 'checkbox', nil, 'UseDebuff',
        'bool')
    self:addOption('USEREPTILE', 'Use Reptile Buff', false, nil, 'Use Skin of the Reptile proc buff', 'checkbox', nil,
        'UseReptile', 'bool')
    ...
    self:addOption('USECHEETAH', 'Use Cheetah', true, nil, 'Toggle use of group cheetah AA', 'checkbox', nil,
        'UseCheetah', 'bool')
end
...
Druid.SpellLines = {
    ...
    { Group = 'dot3',   Spells = { 'Sunscald', 'Sunpyre', 'Sunshock', 'Sunflame', 'Sunflash', 'Vengeance of the Sun' },              Options = { opt = 'USEDOTS', Gem = function(
        lvl) return lvl > 65 and 7 or nil end } },
    ...
    { Group = 'nuke3',      Spells = { 'Summer Sunscald', 'Summer Sunpyre', 'Summer Sunshock', 'Summer Sunflame', 'Summer Sunfire', 'Dawnstrike', 'Sylvan Fire', 'Wildfire', 'Scoriae', 'Firestrike' },                                                                                  Options = { opt = 'USENUKES', Gem = function(
        lvl) return lvl > 65 and 2 end } },
    ...
    { Group = 'pet',        Spells = { 'Nature Wanderer\'s Behest' },                                                                                                                                                                                                                    Options = { opt = 'USEPET', postcast = function()
    ...
    { Group = 'reptile',    Spells = { 'Chitin of the Reptile', 'Bulwark of the Reptile', 'Defense of the Reptile', 'Guard of the Reptile', 'Pellicle of the Reptile', 'Skin of the Reptile' },                                                                                          Options = { Gem = function(
        lvl) return lvl <= 70 and 11 end, opt = 'USEREPTILE', combatbuffothers = true, selfbuff = true, alias = 'REPTILE', singlebuff = true, classes = { MNK = true, WAR = true, PAL = true, SHD = true } } },                                                                                                                                                                          -- debuff on hit, lowers atk++AC
    ...
    { Group = 'rainnuke',   Spells = { 'Tempest Wind', 'Lightning Strike', 'Pogonip', 'Cascade of Hail', 'Invoke Lightning' },                                                                                                                                                           Options = { opt = 'USEAOE', Gem = function(
        lvl) return lvl <= 70 and 12 end } },
...
Druid.compositeNames = { ['Ecliptic Winds'] = true, ['Composite Winds'] = true, ['Dissident Winds'] = true,
    ['Dichotomic Winds'] = true, }
Druid.allDPSSpellGroups = { 'dot1', 'dot2', 'dot3', 'dot4', 'dot5', 'tcnuke', 'nuke1', 'nuke2', 'nuke3', 'nuke4',
    'pbaenuke', 'summonednuke', 'outdoornuke', 'rainnuke', 'snare' }
...
Druid.Abilities = {
    ...
    -- Buffs
    {
        ...
        Options = { opt = 'USECHEETAH', selfbuff = true, condition = function() return mq.TLO.Me.CombatState() ~=
            'COMBAT' end },
    },
    {
        Type = 'AA',
