...
function Paladin:init()
    self.classOrder = { 'assist', 'heal', 'rez', 'cast', 'mash', 'burn', 'recover', 'buff', 'rest' }
...
function Paladin:initClassOptions()
    self:addOption('USEATTRACTION', 'Use Divine Call', true, nil, 'Toggle use of Divine Call AA', 'checkbox', nil,
        'UseAttraction', 'bool')
