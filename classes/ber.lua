...
function Berserker:initClassOptions()
    if state.emu then
        ...
        self:addOption('USEEPIC', 'Use Epic', true, nil, 'Toggle use of epic 2.0 click', 'checkbox', nil, 'UseEpic',
            'bool')
    end
end
...
Berserker.Abilities = {
    ...
    },
    {
        ...
        Options = { aurabuff = true, combat = false, condition = function() return not mq.TLO.Me.Song(
            'Aura of Rage Effect')() and not mq.TLO.Me.Song('Bloodlust Aura')() end }
    },
    {
        Type = 'Disc',
        Group = 'summonaxe',
