...
function Wizard:initClassOptions()
    self:addOption('USEDISPEL', 'Use Dispel', true, nil, 'Dispel mobs with Eradicate Magic AA', 'checkbox', nil,
        'UseDispel', 'bool')
    self:addOption('USEHARVEST', 'Use Harvest', true, nil, 'Toggle use of Harvest spell/AA', 'checkbox', nil,
        'UseHarvest', 'bool')
end
...
Wizard.SpellLines = {{
    Group = 'largefire',
    Spells = {'Ether Flame', 'Corona Flare', 'White Fire', 'Strike of Solusek', 'Conflagration', 'Fire Bolt'},
    Options = {}
}, {
    Group = 'weavenuke',
    Spells = {'Ether Flame', 'Corona Flare', 'White Fire', 'Strike of Solusek', 'Conflagration', 'Fire Bolt'},
    Options = {
        condition = function()
            return mq.TLO.Me.Buff('Weave of Power')() or mq.TLO.Me.Song('Weave of Power')()
        end
    }
}, {
    Group = 'stun',
    Spells = {'Telakemara', 'Telekara', 'Telaka', 'Telekin', 'Markar\'s Discord', 'Tishan\'s Discord',
              'Markar\'s Clash', 'Tishan\'s Clash', 'Thunderclap'},
    Options = {}
}, {
    Group = 'firerain',
    Spells = { --[['Tears of the Sun', 'Tears of Arlyxir', ]] 'Tears of Ro', 'Tears of Solusek', 'Lava Storm',
                                                              'Firestorm'},
    Options = {
        opt = 'USEAOE'
    }
    ...
    Group = 'icerain',
    Spells = {'Gelid Rains', 'Tears of Marr', 'Tears of Prexus', 'Frost Storm', 'Icestrike'},
    Options = {
        opt = 'USEAOE'
    }
}, {
    ...
    Options = {
        ...
        condition = function()
            return not mq.TLO.Me.Buff('Weave of Power')() and not mq.TLO.Me.Song('Weave of Power')()
        end
    }
}, {
    Group = 'pbaelightning',
    Spells = {'Circle of Thunder', 'Jyll\'s Static Pulse', 'Cast Force', 'Project Lightning'},
    Options = {
        opt = 'USEAOE',
        condition = function()
            return (mq.TLO.Target.Distance3D() or 100) < 45 and state.mobCountNoPets > 2
        end
    }
}, {
    Group = 'pbaeice',
    Spells = { --[['Winds of Gelid', ]] 'Jyll\'s Zephyr of Ice', 'Numbing Cold'},
    Options = {
        opt = 'USEAOE',
        condition = function()
            return (mq.TLO.Target.Distance3D() or 100) < 45 and state.mobCountNoPets > 2
    ...
    Group = 'pbaefire',
    Spells = { --[['Circle of Fire', ]] 'Jyll\'s Wave of Heat', 'Fingers of Fire'},
    Options = {
        opt = 'USEAOE',
        condition = function()
            return (mq.TLO.Target.Distance3D() or 100) < 45 and state.mobCountNoPets > 2
    ...
    Group = 'dispel',
    Spells = {'Annul Magic', 'Nullify Magic', 'Cancel Magic'},
    Options = {
        debuff = true,
        dispel = true,
        opt = 'USEDISPEL'
...
{
    Group = 'hpbuff',
    Spells = {'Ether Shield', 'Greater Shielding', 'Major Shielding', 'Shielding', 'Lesser Shielding', 'Minor Shielding'},
    Options = {
        selfbuff = true
    }
}, {
    Group = 'largeice',
    Spells = {'Gelidin Comet', 'Ice Meteor', 'Ice Comet'},
    Options = {}
}, -- Gem=3
{
    Group = 'smallice',
    Spells = {'Claw of Vox', 'Spark of Ice', 'Claw of Frost', 'Ice Shock', 'Frost Shock', 'Shock of Ice',
              'Blast of Cold'},
    Options = {}
}, -- Gem=1
{
    Group = 'fastice',
    Spells = {'Ancient: Spear of Gelaqua', 'Black Ice', 'Ice Spear of Solist', 'Draught of E`ci', 'Draught of Ice'},
    Options = {}
}, -- Gem=2
{
    Group = 'lureice',
    Spells = {'Icebane', 'Lure of Ice', 'Lure of Frost'},
    Options = {}
}, -- Gem=12
...
{
    Group = 'smallfire',
    Spells = {'Inferno Shock', 'Flame Shock', 'Shock of Fire'},
    Options = {}
}, -- Gem=4
{
    Group = 'fastfire',
    Spells = {'Chaos Flame', 'Draught of Ro', 'Draught of Fire'},
    Options = {}
}, -- Gem=5
{
    Group = 'lurefire',
    Spells = {'Firebane', 'Lure of Ro', 'Lure of Flame', 'Enticement of Flame'},
    Options = {}
}, -- Gem=11
...
{
    Group = 'concussion',
    Spells = {'	Ancient: Greater Concussion', 'Concussion'},
    Options = {
        dps = true,
        condition = function()
            return mq.TLO.Target.PctAggro() or 0 > 70
        end
    }
}, {
    Group = 'lightning',
    Spells = {'Spark of Lightning', 'Thunder Strike', 'Garrison\'s Mighty Mana Shock', 'Force Snap',
              'Shock of Lightning'},
    Options = {}
}, -- Gem=7
{
    Group = 'lightningrain',
    Spells = {'Energy Storm', 'Lightning Storm'},
    Options = {
        opt = 'USEAOE'
    }
},
...
{
    Group = 'lightningstun',
    Spells = {'Spark of Thunder'},
    Options = {}
}, -- Gem=3
{
    Group = 'swarm',
    Spells = {'Solist\'s Frozen Sword'}
}, {
    Group = 'aetrap',
    Spells = {'Fire Rune'}
}, {
    Group = 'ds',
    Spells = {'O`Keil\'s Flickering Flame', 'O`Keil\'s Levity', 'O`Keil\'s Embers', 'O`Keil\'s Radiation'},
    Options = {
        singlebuff = true,
        classes = {}
    }
...
Wizard.compositeNames = {
    ['Ecliptic Fire'] = true,
    ['Composite Fire'] = true,
    ['Dissident Fire'] = true,
    ['Dichotomic Fire'] = true
}
Wizard.allDPSSpellGroups = {'weave', 'weavenuke', 'largemagic', 'largefire', 'largeice', 'smallfire', 'smallice',
                            'firefire', 'fastice', 'fastfire', 'lurefire', 'lureice', 'lightning', 'lightningstun',
                            'stun', 'swarm', 'firerain', 'icerain', 'lightningrain', 'aetrap', 'pbaefire', --[['targetpbaefire', ]]
                            'pbaeice', 'concussion', --[['targetpbaeice', ]] 'pbaelightning' --[['targetpbaelightning']] }

Wizard.Abilities = { -- DPS
{
    Type = 'AA',
    Name = 'Force of Will',
    Options = {
