...
constants.commandHelp = {
    ...
    { command = 'campcustom [x,y,z,heading,zoneid]',                                                          tip = 'Reset the centerpoint of the camp to supplied X,Y,Z coordinates, angle and zone' },
    ...
    { command = 'addclicky <mash|cast|burn|buff|petbuff|heal|defensive|mana|summon|debuff|pull|mount> [key/value]', tip = 'Adds the currently held item to the clicky group specified' },
...
constants.bufflines = {
    ...
    { key = 'HASTE',       label = 'Haste',                           category = 'Standard',        exclusivewith = 'GROUPHASTE' },
    { key = 'GROUPHASTE',  label = 'Haste',                           category = 'Standard',        exclusivewith = 'HASTE' },
    { key = 'EPICHASTE',   label = 'Enc Epic Haste',                  category = 'Standard' },
    { key = 'KEI',         label = 'Clarity',                         category = 'Standard',        exclusivewith = 'SINGLEKEI' },
    { key = 'SINGLEKEI',   label = 'Single Clarity',                  category = 'Standard',        exclusivewith = 'KEI' },
